  ...
  return(
       <div className="page-container" style={{ overflow: "auto" }}>
             <h1>Admissions at Vivekanand College</h1>
                <p> Welcome to the Admissions page of Vivekanand College! We are delighted you're considering joining our vibrant
                   academic community. Our admission process is designed to be straightforward and accessible.</p>
                ...
                <ol>
                    ...
                    <li><b>Fee Payment: </b>Complete the admission by paying the required fees.</li>
                     ...
                     <p>For detailed information on postgraduate program admissions,  specific program syllabi,
                       and fee structures, please visit our<a href="/courses" style={{textDecorationLine:'underline'}}>Courses
                        Page</a>or<a href="/contact" style={{textDecorationLine:'underline'}}>Contact US
                       </a>directly. </p>
