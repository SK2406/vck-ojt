...
const   HomePage = () => {
  return(
        ...
        <div className="page-container" style={{ overflow: "auto" }}>
          ...
          <img src="Images\college-banner.png" alt="Vck-college-photo" className="hero-banner-image"/>
                <div className="hero-overlay-text"><h1> Welcome to Vivekanand College!</h1><br/>
                  <p>Your journey to excellence starts here.</p>
                   <a href="/admissions" className="btn hero-btn">
                              Apply Now!</a>
          ...
          <p>
            <b>Vivekanand College</b> is a premier educational institution dedicated to fostering academic excellence, 
          ...
          <p>
            ...
            Our state-of-the-art facilities, experienced faculty, and diverse student community create a unique 
             ecosystem where curiosity thrives and future leaders are shaped.
                ...
                <ul><li><b>Legacy of Excellence:</b> Decades of commitment to quality education.</li>
                    ...
                    <li><b>Modern Facilities:</b> Well-equipped labs, expansive library, and comfortable campus.</li>
                     ...
                     <li><b>Strong Placements:</b> Excellent career opportunities with leading companies.</li></ul>
        ...
        <img src="Images\campus-life-Crkero7B.jpg" alt="Students on campus ground" />
               ...
               <p>Explore our vibrant campus and state-of-the-art facilities designed to enhance your learnin experience 
